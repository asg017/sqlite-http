...
[![Doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/sqlite-http@0.1.0-alpha.4/mod.ts)
...
import * as sqlite_http from "https://deno.land/x/sqlite_http@v0.1.0-alpha.4/mod.ts";
